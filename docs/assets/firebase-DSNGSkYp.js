 ...
 * limitations under the License.
 */
const aS={};let cS=!1;function uS(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||jw("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Vw("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a=kC(s,i),c=a.repoInfo;"undefined"!=typeof process&&Ew&&(o=Ew.FIREBASE_DATABASE_EMULATOR_HOST),o?(s=`http://${o}?ns=${c.namespace}`,a=kC(s,i),c=a.repoInfo):a.repoInfo.secure;const u=new sb(e.name,e.options,t);XE("Invalid Firebase Database URL",a),Fb(a.path)||jw("Database URL must point to the root of a Firebase Database (not including a child path).");const l=function(e,t,n,r){let i=aS[t.name];i||(i={},aS[t.name]=i);let s=i[e.toURLString()];s&&jw("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new sC(e,cS,n,r),i[e.toURLString()]=s,s}(c,e,u,new ib(e,n));return new lS(l,e)}class lS{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(oC(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new UC(this._repo,Ab())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=aS[t];n&&n[e.key]===e||jw(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&jw("Cannot call "+e+" on a deleted database.")}}function hS(e=gt(),t){const n=lt(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=g("database");e&&function(e,t,n,r={}){e=Z(e),e._checkNotDeleted("useEmulator");const i=`${t}:${n}`,s=e._repoInternal;if(e._instanceStarted){if(i===e._repoInternal.repoInfo_.host&&z(r,s.repoInfo_.emulatorOptions))return;jw("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(s.repoInfo_.nodeAdmin)r.mockUserToken&&jw('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new ob(ob.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:I(r.mockUserToken,e.app.options.projectId);o=new ob(t)}w(t)&&(b(t),C("Database",!0));!function(e,t,n,r){const i=t.lastIndexOf(":"),s=w(t.substring(0,i));e.repoInfo_=new hb(t,s,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0,n),r&&(e.authTokenProvider_=r)}(s,i,r,o)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const dS={".sv":"timestamp"};function fS(){return dS}Wb.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Wb.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},function(e){kw=pt,ut(new ee("database",(e,{instanceIdentifier:t})=>uS(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t),"PUBLIC").setMultipleInstances(!0)),yt(Cw,Sw,e),yt(Cw,Sw,"esm2017")}();export{Cr as A,ii as B,Tr as C,py as D,p_ as E,g_ as F,fr as G,j_ as H,B_ as I,Ar as J,bw as K,vw as L,ww as M,hv as N,Ty as a,Iw as b,hS as c,rS as d,sS as e,KC as f,Bi as g,fS as h,mt as i,YC as j,jC as k,tS as l,kr as m,F_ as n,QC as o,zC as p,oS as q,qC as r,$C as s,my as t,q_ as u,iv as v,Nr as w,Er as x,Sr as y,V_ as z};

  ...
  return (
    <div className="min-h-screen-safe flex flex-col items-center justify-center bg-dark-900 p-4">
      ...
      <div className="mb-8 animate-bounce-slow">
        <div className="w-24 h-24 bg-gradient-to-br from-primary-500 to-primary-700 rounded-3xl flex items-center justify-center shadow-2xl shadow-primary-900/50">
          <svg
      ...
      {/* App Name */}
      <h1 className="text-3xl font-bold text-gradient mb-2">Heart Link Surat</h1>
